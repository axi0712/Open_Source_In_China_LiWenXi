...
public class Activity_FenSi extends BaseActivity {
    ...
    protected void getID() {
        mCancle = (ImageView) findViewById(R.id.activity_fensi_canel);
        ...
        mView = (PullToRefreshRecyclerView) findViewById(R.id.fensi_liebiao);
...
//        mEditor.commit();
    ...
    private void loadMode() {
        model.mine_fensi(mShared.getString("uid",""),"0", new MyCallBack() {
            @Override
