...
public class Fragment_Search_blog extends BaseFragment {
    ...
    protected int layoutId() {
        return R.layout.fragment_search_blog;
    }

    @Override
    protected void initView(View view) {
        mView = (PullToRefreshRecyclerView) view.findViewById(R.id.search_blog_recycle);
...
//        });
    ...
    private void loadMode() {
        model.search_Blog(mShared.getString("name",""),"2", new MyCallBack() {
            @Override
...
//                BlogJavaBean homeListBean = (BlogJavaBean) xs.fromXML(strSuccess);
                ...
                Log.i("KANKAN",homeListBean.getResults().toString());
            }
        });
    }
    @Override
