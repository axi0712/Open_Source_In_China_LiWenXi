...
public class Fragment_Search_SoftWare extends BaseFragment {
    ...
    protected void initView(View view) {
        mView = (PullToRefreshRecyclerView) view.findViewById(R.id.search_software_recycle);
...
//                        mEditor.commit();
    ...
    private void loadMode() {
        model.search_SoftWare(mShared.getString("name",""),"2", new MyCallBack() {
            @Override
